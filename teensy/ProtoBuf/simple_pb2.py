...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0csimple.proto\"2\n\rSimpleMessage\x12\x0f\n\x07on_time\x18\x01 \x02(\x05\x12\x10\n\x08off_time\x18\x02 \x02(\x05')
)
...
_SIMPLEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='on_time', full_name='SimpleMessage.on_time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='off_time', full_name='SimpleMessage.off_time', index=1,
